...
export PYTHONPATH=$PYTHONPATH:/auto/homes/sn611/saasha/toolkit_new_no_signal_REFACTORED
...
export REP_NUM=2 ## experiments are repeated 10 times per route with a different seed value
