...
class GlobalRoutePlanner(object):
    ...
    def trace_route(self, origin, destination):
        ...
        current_waypoint = self._wmap.get_waypoint(origin, project_to_road=True, lane_type=carla.LaneType.Driving)
        destination_waypoint = self._wmap.get_waypoint(destination, project_to_road=True, lane_type=carla.LaneType.Driving)
