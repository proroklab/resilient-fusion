...
class AutoPilot(MapAgent):
    ...
    def run_step(self, tick_data, timestamp):
        ...
        if self.step % 10 == 0 and self.save_path is not None:
            self.save(near_node, far_node, near_command, steer, throttle, brake, target_speed, tick_data)
    ...
    def preprocess_image(self, rgb):
        ...
        rgb = scale_and_crop_image(rgb, crop=256) ## TODO: fix this, currently borrows the method from transfuser
