...
class RouteScenario(BasicScenario):
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        #print('Potential scenarios: ', potential_scenarios_definitions)
        ...
        #print('Sampled scenarios: ', self.sampled_scenarios_definitions)
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            if definition['name'] == 'Scenario3':
                ...
                if random.random() < 0.5:
                    scenario_class =  DynamicObjectCrossing
                else:
                    scenario_class = StationaryObjectCrossing
            else:
            ...
            print('List of other actors: ', scenario_class, list_of_actor_conf_instances)
