...
export TEAM_AGENT=leaderboard/team_code/route_following_agent.py
...
export SAVE_PATH=data/route_following
export RESUME=True

#printf ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator.py
python3 ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator_OLD.py \
--scenarios=${SCENARIOS}  \
--routes=${ROUTES} \
